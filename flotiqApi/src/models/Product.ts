...
export interface Product {
    ...
    productImage?: Array<Media> | Array<DataSource>;
    /**
     * 
     * @type {Array<Media>}
     * @memberof Product
    ...
    productGallery?: Array<Media> | Array<DataSource>;
}
...
export function ProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): Product  {
    if (json == null) {
        ...
        'productImage': json['productImage'] == null ? undefined : ((json['productImage'] as Array<any>).map(MediaFromJSON)),
        'productGallery': json['productGallery'] == null ? undefined : ((json['productGallery'] as Array<any>).map(MediaFromJSON)),
    };
}
...
export function ProductToJSON(value?: Product | null): any {
    ...
    return {
        ...
        'productImage': value['productImage'] == null ? undefined : ((value['productImage'] as Array<any>).map(MediaToJSON)),
        'productGallery': value['productGallery'] == null ? undefined : ((value['productGallery'] as Array<any>).map(MediaToJSON)),
    };
}
