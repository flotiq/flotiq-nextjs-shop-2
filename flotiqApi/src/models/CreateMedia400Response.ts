 ...
 * 
 * @export
 * @interface CreateMedia400Response
 */


export interface CreateMedia400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof CreateMedia400Response
     */
 ...
 */
export function instanceOfCreateMedia400Response(value: object): boolean {
    return true;
}

export function CreateMedia400ResponseFromJSON(json: any): CreateMedia400Response {
    return CreateMedia400ResponseFromJSONTyped(json, false);
}

export function CreateMedia400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateMedia400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function CreateMedia400ResponseToJSON(value?: CreateMedia400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
