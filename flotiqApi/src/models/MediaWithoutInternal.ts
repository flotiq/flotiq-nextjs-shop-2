 ...
 * 
 * @export
 * @interface MediaWithoutInternal
 */
 ...
 */
export function instanceOfMediaWithoutInternal(value: object): boolean {
...
export function MediaWithoutInternalFromJSON(json: any): MediaWithoutInternal {
    return MediaWithoutInternalFromJSONTyped(json, false);
}

export function MediaWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediaWithoutInternal  {
    if (json == null) {
        return json;
    }
        return {
...
export function MediaWithoutInternalToJSON(value?: MediaWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
