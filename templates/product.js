    ...
    return (
        <>
            <div className="flex flex-wrap max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <ProductBackButton
                    additionalClass={['mt-12 mb-5']}
                    backButtonText="Back to all products"
                />
                <div className="flex flex-wrap mb-10">
                    <div className="flex basis-full lg:basis-1/2">
                        <Image
                            src={FlotiqImage.getSrc(
                    ...
                    <div className="flex flex-col basis-full lg:basis-1/2 pl-0 lg:pl-12 pt-5 pb-10 bg-white">
                        <Header
                            additionalClasses={[
                                'text-xl md:text-5xl !font-normal !pb-0',
                            ]}
                        >
                            {product.name}
                        </Header>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:space-x-16 mt-10">
                            <Header
                                additionalClasses={[
                                    'text-red !p-0 order-2 md:order-1 mt-3 md:mt-0',
                                ]}
                            >
                                {`$${product.price}`}
                            </Header>
