 ...
 */
export declare function instanceOfProductVersionsList(value: object): boolean;
export declare function ProductVersionsListFromJSON(json: any): ProductVersionsList;
export declare function ProductVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductVersionsList;
export declare function ProductVersionsListToJSON(value?: ProductVersionsList | null): any;
