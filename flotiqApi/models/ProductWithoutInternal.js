...
exports.ProductWithoutInternalToJSON = exports.ProductWithoutInternalFromJSONTyped = exports.ProductWithoutInternalFromJSON = exports.instanceOfProductWithoutInternal = void 0;
var DataSource_1 = require("./DataSource");
/**
 * Check if a given object implements the ProductWithoutInternal interface.
 */
function instanceOfProductWithoutInternal(value) {
    if (!('id' in value))
        return false;
    if (!('name' in value))
        return false;
...
exports.instanceOfProductWithoutInternal = instanceOfProductWithoutInternal;
function ProductWithoutInternalFromJSON(json) {
    return ProductWithoutInternalFromJSONTyped(json, false);
}
exports.ProductWithoutInternalFromJSON = ProductWithoutInternalFromJSON;
function ProductWithoutInternalFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ProductWithoutInternalFromJSONTyped = ProductWithoutInternalFromJSONTyped;
...
exports.ProductWithoutInternalToJSON = ProductWithoutInternalToJSON;
