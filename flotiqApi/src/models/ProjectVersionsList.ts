...
/**
 * Check if a given object implements the ProjectVersionsList interface.
 */
export function instanceOfProjectVersionsList(value: object): boolean {
...
export function ProjectVersionsListFromJSON(json: any): ProjectVersionsList {
    return ProjectVersionsListFromJSONTyped(json, false);
}

export function ProjectVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectVersionsList  {
    if (json == null) {
        return json;
    }
        return {
...
export function ProjectVersionsListToJSON(value?: ProjectVersionsList | null): any {
    if (value == null) {
        return value;
    }
    return {
