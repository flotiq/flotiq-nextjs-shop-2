...
import type { VersionItemAllOfOwner } from './VersionItemAllOfOwner';
import {
    VersionItemAllOfOwnerFromJSON,
...
export interface VersionItem {
    ...
    /**
     * 
     * @type {VersionItemAllOfOwner}
     * @memberof VersionItem
     */

    owner?: VersionItemAllOfOwner ;
    /**
     * 
     * @type {VersionItemAllOfOwner}
     * @memberof VersionItem
 ...
 */
export function instanceOfVersionItem(value: object): boolean {
...
export function VersionItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionItem  {
    if (json == null) {
        ...
        'owner': json['owner'] == null ? undefined : VersionItemAllOfOwnerFromJSON(json['owner']),
        'editor': json['editor'] == null ? undefined : VersionItemAllOfOwnerFromJSON(json['editor']),
    };
}

export function VersionItemToJSON(value?: VersionItem | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'owner': VersionItemAllOfOwnerToJSON(value['owner']),
        'editor': VersionItemAllOfOwnerToJSON(value['editor']),
    };
}
