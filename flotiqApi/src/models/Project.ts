...
export interface Project {
    ...
    gallery?: Array<Media> | Array<DataSource>;
    /**
     * 
     * @type {string}
     * @memberof Project
...
export function ProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): Project  {
    if (json == null) {
        ...
        'name': json['name'],
        'slug': json['slug'],
        'gallery': json['gallery'] == null ? undefined : ((json['gallery'] as Array<any>).map(MediaFromJSON)),
        'description': json['description'] == null ? undefined : json['description'],
        'headerImage': json['headerImage'] == null ? undefined : ((json['headerImage'] as Array<any>).map(MediaFromJSON)),
...
export function ProjectToJSON(value?: Project | null): any {
    ...
    return {
        ...
        'name': value['name'],
        'slug': value['slug'],
        'gallery': value['gallery'] == null ? undefined : ((value['gallery'] as Array<any>).map(MediaToJSON)),
        'description': value['description'],
        'headerImage': value['headerImage'] == null ? undefined : ((value['headerImage'] as Array<any>).map(MediaToJSON)),
