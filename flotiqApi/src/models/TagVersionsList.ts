 ...
 * 
 * @export
 * @interface TagVersionsList
 */


export interface TagVersionsList {
    /**
     * 
     * @type {number}
     * @memberof TagVersionsList
     */
 ...
 */
export function instanceOfTagVersionsList(value: object): boolean {
...
export function TagVersionsListFromJSON(json: any): TagVersionsList {
    return TagVersionsListFromJSONTyped(json, false);
}

export function TagVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagVersionsList  {
    if (json == null) {
        return json;
    }
        return {
...
export function TagVersionsListToJSON(value?: TagVersionsList | null): any {
    if (value == null) {
        return value;
    }
    return {
