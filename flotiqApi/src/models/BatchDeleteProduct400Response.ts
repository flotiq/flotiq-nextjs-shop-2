 ...
 */
export function instanceOfBatchDeleteProduct400Response(value: object): boolean {
    return true;
}

export function BatchDeleteProduct400ResponseFromJSON(json: any): BatchDeleteProduct400Response {
    return BatchDeleteProduct400ResponseFromJSONTyped(json, false);
}

export function BatchDeleteProduct400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchDeleteProduct400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function BatchDeleteProduct400ResponseToJSON(value?: BatchDeleteProduct400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
