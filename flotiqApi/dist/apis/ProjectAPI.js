            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: requestParameters['ProjectWithoutInternal'].map(index_1.ProjectWithoutInternalToJSON),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.ProjectWithoutInternalToJSON)(requestParameters['ProjectWithoutInternal']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ProjectListFromJSON)(jsonValue); })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/v1/content/project/{id}/version".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ProjectVersionsListFromJSON)(jsonValue); })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.ProjectWithoutRequiredToJSON)(requestParameters['ProjectWithoutRequired']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ProjectFromJSON)(jsonValue); })];
