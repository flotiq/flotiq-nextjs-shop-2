 ...
 * 
 * @export
 * @interface TagWithoutRequired
 */


export interface TagWithoutRequired {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof TagWithoutRequired
     */
 ...
 */
export function instanceOfTagWithoutRequired(value: object): boolean {
    if (!('id' in value)) return false;
    return true;
}

export function TagWithoutRequiredFromJSON(json: any): TagWithoutRequired {
    return TagWithoutRequiredFromJSONTyped(json, false);
}

export function TagWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagWithoutRequired  {
    if (json == null) {
        return json;
    }
        return {
...
export function TagWithoutRequiredToJSON(value?: TagWithoutRequired | null): any {
    if (value == null) {
        return value;
    }
    return {
