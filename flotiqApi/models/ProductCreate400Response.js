...
exports.ProductCreate400ResponseToJSON = exports.ProductCreate400ResponseFromJSONTyped = exports.ProductCreate400ResponseFromJSON = exports.instanceOfProductCreate400Response = void 0;
/**
 * Check if a given object implements the ProductCreate400Response interface.
 */
function instanceOfProductCreate400Response(value) {
    return true;
}
exports.instanceOfProductCreate400Response = instanceOfProductCreate400Response;
function ProductCreate400ResponseFromJSON(json) {
    return ProductCreate400ResponseFromJSONTyped(json, false);
}
exports.ProductCreate400ResponseFromJSON = ProductCreate400ResponseFromJSON;
function ProductCreate400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ProductCreate400ResponseFromJSONTyped = ProductCreate400ResponseFromJSONTyped;
function ProductCreate400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ProductCreate400ResponseToJSON = ProductCreate400ResponseToJSON;
