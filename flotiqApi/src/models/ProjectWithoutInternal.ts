 ...
 * 
 * @export
 * @interface ProjectWithoutInternal
 */


export interface ProjectWithoutInternal {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof ProjectWithoutInternal
     */
    ...
    gallery?: Array<DataSource> | Array<DataSource>;
    /**
     * 
     * @type {string}
     * @memberof ProjectWithoutInternal
...
/**
 * Check if a given object implements the ProjectWithoutInternal interface.
 */
export function instanceOfProjectWithoutInternal(value: object): boolean {
...
export function ProjectWithoutInternalFromJSON(json: any): ProjectWithoutInternal {
    return ProjectWithoutInternalFromJSONTyped(json, false);
}

export function ProjectWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectWithoutInternal  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'name': json['name'],
        'slug': json['slug'],
        'gallery': json['gallery'] == null ? undefined : ((json['gallery'] as Array<any>).map(DataSourceFromJSON)),
        'description': json['description'] == null ? undefined : json['description'],
        'headerImage': json['headerImage'] == null ? undefined : ((json['headerImage'] as Array<any>).map(DataSourceFromJSON)),
...
export function ProjectWithoutInternalToJSON(value?: ProjectWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'name': value['name'],
        'slug': value['slug'],
        'gallery': value['gallery'] == null ? undefined : ((value['gallery'] as Array<any>).map(DataSourceToJSON)),
        'description': value['description'],
        'headerImage': value['headerImage'] == null ? undefined : ((value['headerImage'] as Array<any>).map(DataSourceToJSON)),
