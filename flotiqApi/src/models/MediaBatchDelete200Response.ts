 ...
 * 
 * @export
 * @interface MediaBatchDelete200Response
 */


export interface MediaBatchDelete200Response {
    /**
     * 
     * @type {number}
     * @memberof MediaBatchDelete200Response
     */
...
/**
 * Check if a given object implements the MediaBatchDelete200Response interface.
 */
export function instanceOfMediaBatchDelete200Response(value: object): boolean {
    return true;
}

export function MediaBatchDelete200ResponseFromJSON(json: any): MediaBatchDelete200Response {
    return MediaBatchDelete200ResponseFromJSONTyped(json, false);
}

export function MediaBatchDelete200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediaBatchDelete200Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function MediaBatchDelete200ResponseToJSON(value?: MediaBatchDelete200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
