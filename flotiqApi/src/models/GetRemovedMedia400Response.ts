 ...
 * 
 * @export
 * @interface GetRemovedMedia400Response
 */


export interface GetRemovedMedia400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof GetRemovedMedia400Response
     */
 ...
 */
export function instanceOfGetRemovedMedia400Response(value: object): boolean {
    return true;
}

export function GetRemovedMedia400ResponseFromJSON(json: any): GetRemovedMedia400Response {
    return GetRemovedMedia400ResponseFromJSONTyped(json, false);
}

export function GetRemovedMedia400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetRemovedMedia400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function GetRemovedMedia400ResponseToJSON(value?: GetRemovedMedia400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
