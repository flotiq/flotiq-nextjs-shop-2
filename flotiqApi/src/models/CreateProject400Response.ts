 ...
 * 
 * @export
 * @interface CreateProject400Response
 */
...
export interface CreateProject400Response {
     ...
     * 
     * @type {Array<string>}
     * @memberof CreateProject400Response
     */
 ...
 */
export function instanceOfCreateProject400Response(value: object): boolean {
    return true;
}

export function CreateProject400ResponseFromJSON(json: any): CreateProject400Response {
    return CreateProject400ResponseFromJSONTyped(json, false);
}

export function CreateProject400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateProject400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function CreateProject400ResponseToJSON(value?: CreateProject400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
