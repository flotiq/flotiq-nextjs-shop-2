...
exports.ProjectVersionsListToJSON = exports.ProjectVersionsListFromJSONTyped = exports.ProjectVersionsListFromJSON = exports.instanceOfProjectVersionsList = void 0;
var VersionItem_1 = require("./VersionItem");
/**
 * Check if a given object implements the ProjectVersionsList interface.
 */
function instanceOfProjectVersionsList(value) {
...
exports.instanceOfProjectVersionsList = instanceOfProjectVersionsList;
function ProjectVersionsListFromJSON(json) {
    return ProjectVersionsListFromJSONTyped(json, false);
}
exports.ProjectVersionsListFromJSON = ProjectVersionsListFromJSON;
function ProjectVersionsListFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ProjectVersionsListFromJSONTyped = ProjectVersionsListFromJSONTyped;
function ProjectVersionsListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ProjectVersionsListToJSON = ProjectVersionsListToJSON;
