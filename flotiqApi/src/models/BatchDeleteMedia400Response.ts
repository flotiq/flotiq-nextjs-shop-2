 ...
 * 
 * @export
 * @interface BatchDeleteMedia400Response
 */


export interface BatchDeleteMedia400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof BatchDeleteMedia400Response
     */
 ...
 */
export function instanceOfBatchDeleteMedia400Response(value: object): boolean {
    return true;
}

export function BatchDeleteMedia400ResponseFromJSON(json: any): BatchDeleteMedia400Response {
    return BatchDeleteMedia400ResponseFromJSONTyped(json, false);
}

export function BatchDeleteMedia400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchDeleteMedia400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function BatchDeleteMedia400ResponseToJSON(value?: BatchDeleteMedia400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
