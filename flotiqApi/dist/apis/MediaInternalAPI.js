...
exports.MediaInternalAPI = void 0;
var runtime = require("../runtime");
var index_1 = require("../models/index");
/**
 *
 */
var MediaInternalAPI = /** @class */ (function (_super) {
    __extends(MediaInternalAPI, _super);
    function MediaInternalAPI() {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.MediaListFromJSON)(jsonValue); })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/v1/content/_media/{id}/version".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.MediaVersionsListFromJSON)(jsonValue); })];
                }
            });
        });
    };
    ...
    return MediaInternalAPI;
}(runtime.BaseAPI));
exports.MediaInternalAPI = MediaInternalAPI;
