 ...
 */
export function instanceOfBatchDeleteProject400Response(value: object): boolean {
    return true;
}

export function BatchDeleteProject400ResponseFromJSON(json: any): BatchDeleteProject400Response {
    return BatchDeleteProject400ResponseFromJSONTyped(json, false);
}

export function BatchDeleteProject400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchDeleteProject400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function BatchDeleteProject400ResponseToJSON(value?: BatchDeleteProject400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
