...
exports.CreateProduct400ResponseToJSON = exports.CreateProduct400ResponseFromJSONTyped = exports.CreateProduct400ResponseFromJSON = exports.instanceOfCreateProduct400Response = void 0;
/**
 * Check if a given object implements the CreateProduct400Response interface.
 */
function instanceOfCreateProduct400Response(value) {
    return true;
}
exports.instanceOfCreateProduct400Response = instanceOfCreateProduct400Response;
function CreateProduct400ResponseFromJSON(json) {
    return CreateProduct400ResponseFromJSONTyped(json, false);
}
exports.CreateProduct400ResponseFromJSON = CreateProduct400ResponseFromJSON;
function CreateProduct400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.CreateProduct400ResponseFromJSONTyped = CreateProduct400ResponseFromJSONTyped;
function CreateProduct400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.CreateProduct400ResponseToJSON = CreateProduct400ResponseToJSON;
