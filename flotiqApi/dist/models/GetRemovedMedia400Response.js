...
exports.GetRemovedMedia400ResponseToJSON = exports.GetRemovedMedia400ResponseFromJSONTyped = exports.GetRemovedMedia400ResponseFromJSON = exports.instanceOfGetRemovedMedia400Response = void 0;
/**
 * Check if a given object implements the GetRemovedMedia400Response interface.
 */
function instanceOfGetRemovedMedia400Response(value) {
    return true;
}
exports.instanceOfGetRemovedMedia400Response = instanceOfGetRemovedMedia400Response;
function GetRemovedMedia400ResponseFromJSON(json) {
    return GetRemovedMedia400ResponseFromJSONTyped(json, false);
}
exports.GetRemovedMedia400ResponseFromJSON = GetRemovedMedia400ResponseFromJSON;
function GetRemovedMedia400ResponseFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.GetRemovedMedia400ResponseFromJSONTyped = GetRemovedMedia400ResponseFromJSONTyped;
function GetRemovedMedia400ResponseToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.GetRemovedMedia400ResponseToJSON = GetRemovedMedia400ResponseToJSON;
