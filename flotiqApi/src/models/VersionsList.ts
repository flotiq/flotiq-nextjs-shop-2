 ...
 */
export function instanceOfVersionsList(value: object): boolean {
...
export function VersionsListFromJSON(json: any): VersionsList {
    return VersionsListFromJSONTyped(json, false);
}

export function VersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): VersionsList  {
    if (json == null) {
        return json;
    }
        return {
...
export function VersionsListToJSON(value?: VersionsList | null): any {
    if (value == null) {
        return value;
    }
    return {
