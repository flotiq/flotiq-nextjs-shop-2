...
import {
    MediaWithoutInternalAllOfVariantsFromJSON,
 ...
 * 
 * @export
 * @interface MediaWithoutRequired
 */


export interface MediaWithoutRequired {
    /**
 ...
 */
export function instanceOfMediaWithoutRequired(value: object): boolean {
    if (!('id' in value)) return false;
    return true;
}

export function MediaWithoutRequiredFromJSON(json: any): MediaWithoutRequired {
    return MediaWithoutRequiredFromJSONTyped(json, false);
}

export function MediaWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediaWithoutRequired  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'tags': json['tags'] == null ? undefined : ((json['tags'] as Array<any>).map(DataSourceFromJSON)),
        ...
        'variants': json['variants'] == null ? undefined : ((json['variants'] as Array<any>).map(MediaWithoutInternalAllOfVariantsFromJSON)),
        'extension': json['extension'] == null ? undefined : json['extension'],
        'externalId': json['externalId'] == null ? undefined : json['externalId'],
    };
}

export function MediaWithoutRequiredToJSON(value?: MediaWithoutRequired | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'url': value['url'],
        'size': value['size'],
        'tags': value['tags'] == null ? undefined : ((value['tags'] as Array<any>).map(DataSourceToJSON)),
        'type': value['type'],
        'width': value['width'],
        'height': value['height'],
        'source': value['source'],
        ...
        'variants': value['variants'] == null ? undefined : ((value['variants'] as Array<any>).map(MediaWithoutInternalAllOfVariantsToJSON)),
