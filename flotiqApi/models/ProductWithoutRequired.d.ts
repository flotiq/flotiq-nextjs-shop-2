 ...
 */
export declare function instanceOfProductWithoutRequired(value: object): boolean;
export declare function ProductWithoutRequiredFromJSON(json: any): ProductWithoutRequired;
export declare function ProductWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductWithoutRequired;
export declare function ProductWithoutRequiredToJSON(value?: ProductWithoutRequired | null): any;
