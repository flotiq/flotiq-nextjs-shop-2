 ...
 * 
 * @export
 * @interface ProjectBatchDelete400Response
 */


export interface ProjectBatchDelete400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof ProjectBatchDelete400Response
     */
...
/**
 * Check if a given object implements the ProjectBatchDelete400Response interface.
 */
export function instanceOfProjectBatchDelete400Response(value: object): boolean {
    return true;
}

export function ProjectBatchDelete400ResponseFromJSON(json: any): ProjectBatchDelete400Response {
    return ProjectBatchDelete400ResponseFromJSONTyped(json, false);
}

export function ProjectBatchDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectBatchDelete400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function ProjectBatchDelete400ResponseToJSON(value?: ProjectBatchDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
