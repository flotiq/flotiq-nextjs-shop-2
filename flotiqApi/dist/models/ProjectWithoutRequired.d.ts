 ...
 */
export declare function instanceOfProjectWithoutRequired(value: object): boolean;
export declare function ProjectWithoutRequiredFromJSON(json: any): ProjectWithoutRequired;
export declare function ProjectWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectWithoutRequired;
export declare function ProjectWithoutRequiredToJSON(value?: ProjectWithoutRequired | null): any;
