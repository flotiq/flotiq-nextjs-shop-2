 ...
 */
export function instanceOfListMedia400Response(value: object): boolean {
    return true;
}

export function ListMedia400ResponseFromJSON(json: any): ListMedia400Response {
    return ListMedia400ResponseFromJSONTyped(json, false);
}

export function ListMedia400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListMedia400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function ListMedia400ResponseToJSON(value?: ListMedia400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
