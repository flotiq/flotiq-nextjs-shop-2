...
export async function getProducts(
    ...
    return await api.Product.listProduct({page:page, limit:limit, filters:filters, order_by: orderBy});
}
...
export async function getProductBySlug(slug) {
    ...
    const api = new FlotiqApi(apiKey);
    return await api.Product.listProduct({filters: filters, page: 1, limit: 1});
}
