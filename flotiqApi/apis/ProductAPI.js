            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: requestParameters['ProductWithoutInternal'].map(index_1.ProductWithoutInternalToJSON),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.ProductWithoutInternalToJSON)(requestParameters['ProductWithoutInternal']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ProductListFromJSON)(jsonValue); })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _c.label = 2;
                    case 2: return [4 /*yield*/, this.request({
                            path: "/api/v1/content/product/{id}/version".replace("{".concat("id", "}"), encodeURIComponent(String(requestParameters['id']))),
                            method: 'GET',
                            headers: headerParameters,
                            query: queryParameters,
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ProductVersionsListFromJSON)(jsonValue); })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            headers: headerParameters,
                            query: queryParameters,
                            body: (0, index_1.ProductWithoutRequiredToJSON)(requestParameters['ProductWithoutRequired']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.ProductFromJSON)(jsonValue); })];
