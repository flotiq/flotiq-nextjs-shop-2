 ...
 */
export declare function instanceOfProjectWithoutInternal(value: object): boolean;
export declare function ProjectWithoutInternalFromJSON(json: any): ProjectWithoutInternal;
export declare function ProjectWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectWithoutInternal;
export declare function ProjectWithoutInternalToJSON(value?: ProjectWithoutInternal | null): any;
