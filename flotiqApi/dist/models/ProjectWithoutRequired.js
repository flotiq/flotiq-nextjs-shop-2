...
exports.ProjectWithoutRequiredToJSON = exports.ProjectWithoutRequiredFromJSONTyped = exports.ProjectWithoutRequiredFromJSON = exports.instanceOfProjectWithoutRequired = void 0;
 ...
 */
function instanceOfProjectWithoutRequired(value) {
    if (!('id' in value))
        return false;
    return true;
}
exports.instanceOfProjectWithoutRequired = instanceOfProjectWithoutRequired;
function ProjectWithoutRequiredFromJSON(json) {
    return ProjectWithoutRequiredFromJSONTyped(json, false);
}
exports.ProjectWithoutRequiredFromJSON = ProjectWithoutRequiredFromJSON;
function ProjectWithoutRequiredFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ProjectWithoutRequiredFromJSONTyped = ProjectWithoutRequiredFromJSONTyped;
function ProjectWithoutRequiredToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ProjectWithoutRequiredToJSON = ProjectWithoutRequiredToJSON;
