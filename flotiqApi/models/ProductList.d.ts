 ...
 */
export declare function instanceOfProductList(value: object): boolean;
export declare function ProductListFromJSON(json: any): ProductList;
export declare function ProductListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductList;
export declare function ProductListToJSON(value?: ProductList | null): any;
