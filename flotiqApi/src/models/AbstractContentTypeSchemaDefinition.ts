 ...
 * 
 * @export
 * @interface AbstractContentTypeSchemaDefinition
 */


export interface AbstractContentTypeSchemaDefinition {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof AbstractContentTypeSchemaDefinition
     */
 ...
 */
export function instanceOfAbstractContentTypeSchemaDefinition(value: object): boolean {
    if (!('id' in value)) return false;
    return true;
}

export function AbstractContentTypeSchemaDefinitionFromJSON(json: any): AbstractContentTypeSchemaDefinition {
    return AbstractContentTypeSchemaDefinitionFromJSONTyped(json, false);
}

export function AbstractContentTypeSchemaDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbstractContentTypeSchemaDefinition  {
    if (json == null) {
        return json;
    }
        return {
...
export function AbstractContentTypeSchemaDefinitionToJSON(value?: AbstractContentTypeSchemaDefinition | null): any {
    if (value == null) {
        return value;
    }
    return {
