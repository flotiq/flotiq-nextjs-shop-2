 ...
 * 
 * @export
 * @interface MediaVersionsList
 */


export interface MediaVersionsList {
    /**
     * 
     * @type {number}
     * @memberof MediaVersionsList
     */
 ...
 */
export function instanceOfMediaVersionsList(value: object): boolean {
...
export function MediaVersionsListFromJSON(json: any): MediaVersionsList {
    return MediaVersionsListFromJSONTyped(json, false);
}

export function MediaVersionsListFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediaVersionsList  {
    if (json == null) {
        return json;
    }
        return {
...
export function MediaVersionsListToJSON(value?: MediaVersionsList | null): any {
    if (value == null) {
        return value;
    }
    return {
