...
exports.ProjectWithoutInternalToJSON = exports.ProjectWithoutInternalFromJSONTyped = exports.ProjectWithoutInternalFromJSON = exports.instanceOfProjectWithoutInternal = void 0;
var DataSource_1 = require("./DataSource");
/**
 * Check if a given object implements the ProjectWithoutInternal interface.
 */
function instanceOfProjectWithoutInternal(value) {
    if (!('id' in value))
        return false;
    if (!('name' in value))
        return false;
...
exports.instanceOfProjectWithoutInternal = instanceOfProjectWithoutInternal;
function ProjectWithoutInternalFromJSON(json) {
    return ProjectWithoutInternalFromJSONTyped(json, false);
}
exports.ProjectWithoutInternalFromJSON = ProjectWithoutInternalFromJSON;
function ProjectWithoutInternalFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.ProjectWithoutInternalFromJSONTyped = ProjectWithoutInternalFromJSONTyped;
function ProjectWithoutInternalToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ProjectWithoutInternalToJSON = ProjectWithoutInternalToJSON;
