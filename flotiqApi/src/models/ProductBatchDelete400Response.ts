 ...
 * 
 * @export
 * @interface ProductBatchDelete400Response
 */


export interface ProductBatchDelete400Response {
    /**
     * 
     * @type {Array<string>}
     * @memberof ProductBatchDelete400Response
     */
 ...
 */
export function instanceOfProductBatchDelete400Response(value: object): boolean {
    return true;
}

export function ProductBatchDelete400ResponseFromJSON(json: any): ProductBatchDelete400Response {
    return ProductBatchDelete400ResponseFromJSONTyped(json, false);
}

export function ProductBatchDelete400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductBatchDelete400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function ProductBatchDelete400ResponseToJSON(value?: ProductBatchDelete400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
