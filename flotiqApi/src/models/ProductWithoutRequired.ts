 ...
 * 
 * @export
 * @interface ProductWithoutRequired
 */


export interface ProductWithoutRequired {
    /**
     * Unique ID of the object
     * @type {string}
     * @memberof ProductWithoutRequired
     */
    ...
    productImage?: Array<DataSource> | Array<DataSource>;
    /**
     * 
     * @type {Array<DataSource>}
     * @memberof ProductWithoutRequired
    ...
    productGallery?: Array<DataSource> | Array<DataSource>;
}
 ...
 */
export function instanceOfProductWithoutRequired(value: object): boolean {
    if (!('id' in value)) return false;
    return true;
}

export function ProductWithoutRequiredFromJSON(json: any): ProductWithoutRequired {
    return ProductWithoutRequiredFromJSONTyped(json, false);
}

export function ProductWithoutRequiredFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductWithoutRequired  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'productImage': json['productImage'] == null ? undefined : ((json['productImage'] as Array<any>).map(DataSourceFromJSON)),
        'productGallery': json['productGallery'] == null ? undefined : ((json['productGallery'] as Array<any>).map(DataSourceFromJSON)),
    };
}

export function ProductWithoutRequiredToJSON(value?: ProductWithoutRequired | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'productImage': value['productImage'] == null ? undefined : ((value['productImage'] as Array<any>).map(DataSourceToJSON)),
        'productGallery': value['productGallery'] == null ? undefined : ((value['productGallery'] as Array<any>).map(DataSourceToJSON)),
    };
}
