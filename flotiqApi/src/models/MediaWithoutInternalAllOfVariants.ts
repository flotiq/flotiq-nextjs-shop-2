...
import type { MediaWithoutInternalAllOfTrim } from './MediaWithoutInternalAllOfTrim';
import {
    MediaWithoutInternalAllOfTrimFromJSON,
 ...
 * 
 * @export
 * @interface MediaWithoutInternalAllOfVariants
 */


export interface MediaWithoutInternalAllOfVariants {
    /**
     * 
     * @type {string}
     * @memberof MediaWithoutInternalAllOfVariants
     */

    name: string ;
    /**
     * 
     * @type {MediaWithoutInternalAllOfTrim}
     * @memberof MediaWithoutInternalAllOfVariants
     */

    trim?: MediaWithoutInternalAllOfTrim ;
}
 ...
 */
export function instanceOfMediaWithoutInternalAllOfVariants(value: object): boolean {
    if (!('name' in value)) return false;
    return true;
}

export function MediaWithoutInternalAllOfVariantsFromJSON(json: any): MediaWithoutInternalAllOfVariants {
    return MediaWithoutInternalAllOfVariantsFromJSONTyped(json, false);
}

export function MediaWithoutInternalAllOfVariantsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MediaWithoutInternalAllOfVariants  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'name': json['name'],
        'trim': json['trim'] == null ? undefined : MediaWithoutInternalAllOfTrimFromJSON(json['trim']),
    };
}

export function MediaWithoutInternalAllOfVariantsToJSON(value?: MediaWithoutInternalAllOfVariants | null): any {
    if (value == null) {
        return value;
    }
    return {
