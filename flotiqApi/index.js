...
var hydrateMiddleware = function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, __assign(__assign({}, ctx), { init: __assign({}, ctx.init) })];
    });
}); };
var FlotiqApi = /** @class */ (function () {
    function FlotiqApi(key) {
        var configParameters = {
            apiKey: key
        };
        var configuration = new runtime.Configuration(configParameters);
