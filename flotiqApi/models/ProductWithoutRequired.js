...
exports.ProductWithoutRequiredToJSON = exports.ProductWithoutRequiredFromJSONTyped = exports.ProductWithoutRequiredFromJSON = exports.instanceOfProductWithoutRequired = void 0;
var AbstractContentTypeSchemaDefinitionInternal_1 = require("./AbstractContentTypeSchemaDefinitionInternal");
var DataSource_1 = require("./DataSource");
/**
 * Check if a given object implements the ProductWithoutRequired interface.
 */
function instanceOfProductWithoutRequired(value) {
    if (!('id' in value))
        return false;
    return true;
}
exports.instanceOfProductWithoutRequired = instanceOfProductWithoutRequired;
function ProductWithoutRequiredFromJSON(json) {
    return ProductWithoutRequiredFromJSONTyped(json, false);
}
exports.ProductWithoutRequiredFromJSON = ProductWithoutRequiredFromJSON;
function ProductWithoutRequiredFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
        ...
        'productImage': json['productImage'] == null ? undefined : (json['productImage'].map(DataSource_1.DataSourceFromJSON)),
        'productGallery': json['productGallery'] == null ? undefined : (json['productGallery'].map(DataSource_1.DataSourceFromJSON)),
    };
}
exports.ProductWithoutRequiredFromJSONTyped = ProductWithoutRequiredFromJSONTyped;
function ProductWithoutRequiredToJSON(value) {
    ...
    return {
        ...
        'productImage': value['productImage'] == null ? undefined : (value['productImage'].map(DataSource_1.DataSourceToJSON)),
        'productGallery': value['productGallery'] == null ? undefined : (value['productGallery'].map(DataSource_1.DataSourceToJSON)),
    };
}
exports.ProductWithoutRequiredToJSON = ProductWithoutRequiredToJSON;
