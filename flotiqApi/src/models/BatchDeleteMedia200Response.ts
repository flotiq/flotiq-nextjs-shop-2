 ...
 */
export function instanceOfBatchDeleteMedia200Response(value: object): boolean {
    return true;
}

export function BatchDeleteMedia200ResponseFromJSON(json: any): BatchDeleteMedia200Response {
    return BatchDeleteMedia200ResponseFromJSONTyped(json, false);
}

export function BatchDeleteMedia200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchDeleteMedia200Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function BatchDeleteMedia200ResponseToJSON(value?: BatchDeleteMedia200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
