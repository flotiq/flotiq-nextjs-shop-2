...
exports.ProductVersionsListToJSON = exports.ProductVersionsListFromJSONTyped = exports.ProductVersionsListFromJSON = exports.instanceOfProductVersionsList = void 0;
var VersionItem_1 = require("./VersionItem");
/**
 * Check if a given object implements the ProductVersionsList interface.
 */
function instanceOfProductVersionsList(value) {
...
exports.instanceOfProductVersionsList = instanceOfProductVersionsList;
function ProductVersionsListFromJSON(json) {
    return ProductVersionsListFromJSONTyped(json, false);
}
exports.ProductVersionsListFromJSON = ProductVersionsListFromJSON;
...
exports.ProductVersionsListFromJSONTyped = ProductVersionsListFromJSONTyped;
function ProductVersionsListToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.ProductVersionsListToJSON = ProductVersionsListToJSON;
