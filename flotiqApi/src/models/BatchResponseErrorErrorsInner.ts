...
import type { BatchResponseErrorErrorsInnerErrors } from './BatchResponseErrorErrorsInnerErrors';
import {
    BatchResponseErrorErrorsInnerErrorsFromJSON,
    BatchResponseErrorErrorsInnerErrorsFromJSONTyped,
    BatchResponseErrorErrorsInnerErrorsToJSON,
} from './BatchResponseErrorErrorsInnerErrors';
 ...
 * 
 * @export
 * @interface BatchResponseErrorErrorsInner
 */


export interface BatchResponseErrorErrorsInner {
    /**
     * 
     * @type {string}
     * @memberof BatchResponseErrorErrorsInner
     */

    id?: string ;
    /**
     * 
     * @type {BatchResponseErrorErrorsInnerErrors}
     * @memberof BatchResponseErrorErrorsInner
     */

    errors?: BatchResponseErrorErrorsInnerErrors ;
}
 ...
 */
export function instanceOfBatchResponseErrorErrorsInner(value: object): boolean {
    return true;
}

export function BatchResponseErrorErrorsInnerFromJSON(json: any): BatchResponseErrorErrorsInner {
    return BatchResponseErrorErrorsInnerFromJSONTyped(json, false);
}

export function BatchResponseErrorErrorsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchResponseErrorErrorsInner  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'errors': json['errors'] == null ? undefined : BatchResponseErrorErrorsInnerErrorsFromJSON(json['errors']),
    };
}

export function BatchResponseErrorErrorsInnerToJSON(value?: BatchResponseErrorErrorsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'id': value['id'],
        'errors': BatchResponseErrorErrorsInnerErrorsToJSON(value['errors']),
    };
}
