...
import type { BatchResponseErrorErrorsInner } from './BatchResponseErrorErrorsInner';
import {
    BatchResponseErrorErrorsInnerFromJSON,
...
export interface BatchResponseError {
    ...
    /**
     * 
     * @type {Array<BatchResponseErrorErrorsInner>}
     * @memberof BatchResponseError
     */

    errors?: Array<BatchResponseErrorErrorsInner> ;
}
 ...
 */
export function instanceOfBatchResponseError(value: object): boolean {
    return true;
}

export function BatchResponseErrorFromJSON(json: any): BatchResponseError {
    return BatchResponseErrorFromJSONTyped(json, false);
}

export function BatchResponseErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchResponseError  {
    if (json == null) {
        return json;
    }
        return {
        ...
        'errors': json['errors'] == null ? undefined : ((json['errors'] as Array<any>).map(BatchResponseErrorErrorsInnerFromJSON)),
    };
}

export function BatchResponseErrorToJSON(value?: BatchResponseError | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'errors': value['errors'] == null ? undefined : ((value['errors'] as Array<any>).map(BatchResponseErrorErrorsInnerToJSON)),
    };
}
