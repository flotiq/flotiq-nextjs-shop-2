 ...
 * 
 * @export
 * @interface ProductWithoutInternal
 */
...
export interface ProductWithoutInternal {
     ...
     * @type {string}
     * @memberof ProductWithoutInternal
     */
 ...
 */
export function instanceOfProductWithoutInternal(value: object): boolean {
...
export function ProductWithoutInternalFromJSON(json: any): ProductWithoutInternal {
    return ProductWithoutInternalFromJSONTyped(json, false);
}

export function ProductWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductWithoutInternal  {
    if (json == null) {
        return json;
    }
        return {
...
export function ProductWithoutInternalToJSON(value?: ProductWithoutInternal | null): any {
    if (value == null) {
        return value;
    }
    return {
