...
function ProductFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'productImage': json['productImage'] == null ? undefined : (json['productImage'].map(Media_1.MediaFromJSON)),
        'productGallery': json['productGallery'] == null ? undefined : (json['productGallery'].map(Media_1.MediaFromJSON)),
    };
}
...
function ProductToJSON(value) {
    ...
    return {
        ...
        'productImage': value['productImage'] == null ? undefined : (value['productImage'].map(Media_1.MediaToJSON)),
        'productGallery': value['productGallery'] == null ? undefined : (value['productGallery'].map(Media_1.MediaToJSON)),
    };
}
