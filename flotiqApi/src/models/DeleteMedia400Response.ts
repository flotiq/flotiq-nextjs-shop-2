 ...
 */
export function instanceOfDeleteMedia400Response(value: object): boolean {
    return true;
}

export function DeleteMedia400ResponseFromJSON(json: any): DeleteMedia400Response {
    return DeleteMedia400ResponseFromJSONTyped(json, false);
}

export function DeleteMedia400ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteMedia400Response  {
    if (json == null) {
        return json;
    }
        return {
...
export function DeleteMedia400ResponseToJSON(value?: DeleteMedia400Response | null): any {
    if (value == null) {
        return value;
    }
    return {
