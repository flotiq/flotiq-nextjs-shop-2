 ...
 */
export declare function instanceOfProductWithoutInternal(value: object): boolean;
export declare function ProductWithoutInternalFromJSON(json: any): ProductWithoutInternal;
export declare function ProductWithoutInternalFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductWithoutInternal;
export declare function ProductWithoutInternalToJSON(value?: ProductWithoutInternal | null): any;
